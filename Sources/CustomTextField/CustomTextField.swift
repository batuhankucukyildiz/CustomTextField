...
public struct CustomTextField: View {
    ...
    //Text Color
    private var defaultTextColor = CustomTextFieldConfig.shared.defaultTextColor
    private var darkModeTextColor = CustomTextFieldConfig.shared.darkModeTextColor
    //Title Color
    private var defaultTitleColor = CustomTextFieldConfig.shared.defaultTitleColor
    private var darkModeTitleColor = CustomTextFieldConfig.shared.darkModeTitleColor
    //PlaceHolder Text Color
    private var defaultPlaceHolderTextColor = CustomTextFieldConfig.shared.defaultPlaceHolderTextColor
    private var darkModePlaceHolderTextColor = CustomTextFieldConfig.shared.darkModePlaceHolderTextColor
    //Disable Color
    private var defaultDisableColor = CustomTextFieldConfig.shared.defaultDisableColor
    private var darkModeDisableColor = CustomTextFieldConfig.shared.darkModeDisableColor
    //Background Color
    private var defaultBackgroundColor = CustomTextFieldConfig.shared.defaultBackgroundColor
    private var darkModeBackgroundColor = CustomTextFieldConfig.shared.darkModeBackgroundColor
    //Error Text Color
    private var defaultErrorTextColor = CustomTextFieldConfig.shared.defaultErrorTextColor
    private var darkModeErrorTextColor = CustomTextFieldConfig.shared.darkModeErrorTextColor
    //Border Color
    private var defaultBorderColor = CustomTextFieldConfig.shared.defaultBorderColor
    private var darkModeBorderColor = CustomTextFieldConfig.shared.darkModeBorderColor
    //Trailing Image Color
    private var defaultTrailingImageForegroundColor = CustomTextFieldConfig.shared.defaultTrailingImageForegroundColor
    private var darkModeTrailingImageForegroundColor = CustomTextFieldConfig.shared.darkModeTrailingImageForegroundColor
    //Focused Border Color
    private var focusedBorderColorEnable = CustomTextFieldConfig.shared.focusedBorderColorEnable
    private var defaultFocusedBorderColor = CustomTextFieldConfig.shared.defaultFocusedBorderColor
    private var darkModeFocusedBorderColor = CustomTextFieldConfig.shared.darkModeFocusedBorderColor
    //Font
    private var titleFont = CustomTextFieldConfig.shared.titleFont
    private var errorFont = CustomTextFieldConfig.shared.errorFont
    private var placeHolderFont = CustomTextFieldConfig.shared.placeHolderFont
    //Default
    private var borderWidth = CustomTextFieldConfig.shared.borderWidth
    private var cornerRadius = CustomTextFieldConfig.shared.cornerRadius
    private var borderType = CustomTextFieldConfig.shared.borderType
    private var disableAutoCorrection = CustomTextFieldConfig.shared.disableAutoCorrection
    private var textFieldHeight = CustomTextFieldConfig.shared.textFieldHeight
